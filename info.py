...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001928710243').split()]
...
# MongoDB information
#mongodb+srv://JackSparrow:JackSparrow@cluster0.sfmjldk.mongodb.net/?retryWrites=true&w=majority
...
# Custom Chats
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001984107705'))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+0XLmoia03iFhZTVl')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+0XLmoia03iFhZTVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+uUOwgjGaSgI1N2Fl')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+kfnJAaK_Qik2MWY1')
